...
module.exports = class extends Language {
  constructor(...args) {
    ...
    this.language = {
      ...
      RESOLVER_INVALID_TTVUSERFMT: (name) =>
        `${name} does not meet twitch's username requirements.`,
      ...
      COMMAND_INFO: [
        `Halo \`v${botInfo.version}\` is built on Klasa, a 'plug-and-play' framework built on top of the Discord.js library.`,
